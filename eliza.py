...
#  eliza.py
#
#  a tiny Eliza program by Eric Mewes and Sebastian Roeder
#  based on a python script by Joe Strout, Jeff Epler and Jez Higgins
#  
...
#----------------------------------------------------------------------
#  Get POST data, initialize therapist and deliver the input string  
#  from POST to the respond method. 
#----------------------------------------------------------------------
form   = cgi.FieldStorage()  						# Get POST data
userinput  = form.getfirst("userinput")				# Pull userinput field data
therapist = eliza();								
reply = therapist.respond(userinput)				
...
'''
print "Respond:",reply								# Print answer
print '''
</div>
...
<div class="userinput">
<form name="myform" action="./eliza.py" method="post" id="myform"><input name="userinput" type="text" class="c2"> <input type="submit" value="E" class="c3"></form>
</div>
</body>
</html>
'''
